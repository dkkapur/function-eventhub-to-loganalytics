...
namespace LogAnalyticsAPIHandler
{
    class LogAnalyticsAPIConfig
    {
        ...
        public LogAnalyticsAPIConfig(string customerId, string sharedKey, string logName)
        {
        ...
        public void SendData(string jsonData)
        {
            ...
            PostData(signature, datestring, jsonData);
        }
